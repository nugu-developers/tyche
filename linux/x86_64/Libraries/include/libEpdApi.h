...
#define		DATA_LINEAR_PCM16		0					///< 16-bit linear PCM, 16bits, 8/16kHz
#define		DATA_LINEAR_PCM8		1					///< 8-bit linear PCM, 8bits, 8/16kHz
#define		DATA_A_LAW				2					///< A-law, 8bits, 8/16kHz
#define		DATA_MU_LAW				3					///< mu-law, 8bits, 8/16kHz
#define		DATA_SPEEX_STREAM		4					///< speex codec, 8bits, 8/16kHz
#define		DATA_FEAT_STREAM		5					///< speech feature stream, 8bits, 8/16kHz
#define		DataTypeDefined
#endif	// #ifndef DataTypeDefined
...
LIBPUBFUN void LIBCALL epdClientSetDebugOutput(int useDebugOutput);
